                        ...
                        <div class="card-body">
                            <form action="{{route('ubah-presensi')}}" method="post">
                                ...
                                <div class="form-group">
                                    <center>
                                        <label id="clock" style="font-size: 100px; color: #659980; -webkit-text-stroke: 3px #02C39A;text-shadow: 4px 4px 10px #CDE4B1,4px 4px 20px rgba(210, 45, 26, 0.4),4px 4px 30px rgba(210, 25, 16, 0.4),4px 4px 40px rgba(210, 15, 86, 0.4),">
                                        </label>
                                    </center>
                                </div>
                                <center>
